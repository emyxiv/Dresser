...
namespace Dresser.Core {
	public static class ConfigurationManager {
		...
		public static void Load() {
			...
			jsonText = jsonText.Replace("\"$type\":\"CriticalCommonLib.Models.InventoryItem, CriticalCommonLib\"", "\"$type\":\"Dresser.Models.InventoryItem, Dresser\"");
			jsonText = jsonText.Replace("\"$type\":\"Dresser.Structs.Dresser.InventoryItem, Dresser\"", "\"$type\":\"Dresser.Models.InventoryItem, Dresser\"");
