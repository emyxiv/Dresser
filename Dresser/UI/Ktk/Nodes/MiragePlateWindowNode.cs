...
public unsafe class MiragePlateWindowNode : WindowNodeBase {

    // public readonly SimpleComponentNode BackgroundImageNode;
    public readonly NineGridNode BackgroundNode;
    // public readonly WindowBackgroundNode BorderNode;
    public readonly ButtonComponentNode CloseButtonNode;
    public readonly TextureButtonNode ConfigurationButtonNode;
    public readonly NineGridNode DividingLineNode;
    ...
    public MiragePlateWindowNode() {
        ...
        CloseButtonNode = new ButtonComponentNode {
            NodeId = 7,
            Size = new Vector2(28.0f, 28.0f),
            Position = new Vector2(449.0f, 9.0f),
            NodeFlags = NodeFlags.Visible | NodeFlags.Enabled | NodeFlags.EmitsEvents,
        };
        ...
        TitleNode = new TextNode {
            ...
            NodeFlags = NodeFlags.Visible | NodeFlags.Enabled | NodeFlags.Visible | NodeFlags.AnchorTop | NodeFlags.EmitsEvents,
            TextColor = new Vector4(new Vector3(0.392f), 1.0f),
            TextOutlineColor = new Vector4(new Vector3(0.502f), 1.0f),
            BackgroundColor = Vector4.Zero,
    ...
    private void LoadTimelines() {
        ...
        BackgroundNode.AddTimeline(new TimelineBuilder()
        	.AddFrameSetWithFrame(1, 9, 1, multiplyColor: new Vector3(80.0f))
        	.AddFrameSetWithFrame(10, 19, 10, multiplyColor: new Vector3(100.0f))
        	.AddFrameSetWithFrame(20, 29, 20, multiplyColor: new Vector3(80.0f))
            .Build());
